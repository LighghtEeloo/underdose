    ...
    do
        case "${cmd},${i}" in
            ...
            underdose__help,help)
                ...
                ;;
            underdose__help,init)
                cmd="underdose__help__init"
                ;;
            underdose__help,sync)
                cmd="underdose__help__sync"
                ;;
            underdose__help,where)
                cmd="underdose__help__where"
                ;;
            *)
                ;;
        esac
